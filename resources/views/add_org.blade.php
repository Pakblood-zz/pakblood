                ...
                <form>
                    ...
                    <div class="small-20 large-20 columns">
                        <div class="row">
                            <div class="hide-for-small-only medium-7 large-5 columns">
                                <label for="org_name" class="inline">Organization Name : </label>
                            </div>
                            <div class="small-20 medium-10 large-10 columns left">
                                <input type="text" id="org_name" placeholder="Organization Name">
                            </div>
                        </div>
                        <div class="row">
                            <div class="hide-for-small-only medium-7 large-5 columns">
                                <label for="org_address" class="inline">Organization Address : </label>
                            </div>
                            <div class="small-20 large-10 medium-10 columns left">
                                <input type="text" id="org_address" placeholder="Organization Address">
                            </div>
                        </div>
                        <div class="row">
                            <div class="hide-for-small-only medium-7 large-5 columns">
                                <label for="org_phone" class="inline">Organization Phone : </label>
                            </div>
                            <div class="small-20 medium-10 large-10 columns left">
                                <input type="text" id="org_phone" placeholder="Organization Phone">
                            </div>
                        </div>
                        <div class="row">
                            <div class="hide-for-small-only medium-7 large-5 columns">
                    ...
                    <div class="small-20 large-20 columns">
                        <div class="row">
                            ...
                            <div class="hide-for-small-only hide-for-medium-only medium-7 large-4 columns">
                                <label for="admin_pass" class="inline">Password : </label>
                            </div>
                            <div class="small-20 medium-10 large-6 columns left">
                                <input type="text" id="admin_pass" placeholder="Password">
                            </div>
                        </div>
                        <div class="row">
                            <div class="hide-for-small-only hide-for-medium-only medium-7 large-4 columns">
                            ...
                            <div class="small-20 medium-10 large-6 columns left">
                                <input type="text" id="admin_program" placeholder="Degree/Program">
                            </div>
                        </div>
                        <div class="row">
                            <div class="hide-for-small-only hide-for-medium-only medium-7 large-4 columns">
                                <label for="admin_phone" class="inline">Phone/Mobile : </label>
                            </div>
                            <div class="small-20 medium-10 large-6 columns left">
                                <input type="text" id="admin_phone" placeholder="Phone/Mobile">
                            </div>
