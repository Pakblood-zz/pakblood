                    ...
                    <div class="row">
                        ...
                        <div class="small-20 medium-10 large-10 columns left">
                            <select id="city" name="city_id">
                                <option value="208"<?php if ((Auth::user()->city_id) == '208') echo 'selected="selected"'; ?>>
                                    Lahore
                                </option>
                                <option value="169"<?php if ((Auth::user()->city_id) == '169') echo 'selected="selected"'; ?>>
                                    Karachi
                                </option>
                                <option value="130"<?php if ((Auth::user()->city_id) == '130') echo 'selected="selected"'; ?>>
                                    Islamabad
                                </option>
                                <option value="1"<?php if ((Auth::user()->city_id) == '1') echo 'selected="selected"'; ?>>
                                    Abbotabad
                                </option>
                                <option value="4"<?php if ((Auth::user()->city_id) == '4') echo 'selected="selected"'; ?>>
                                    Adda shaiwala
                                </option>
                                <option value="9"<?php if ((Auth::user()->city_id) == '9') echo 'selected="selected"'; ?>>
                                    Arif wala
                                </option>
                                <option value="10"<?php if ((Auth::user()->city_id) == '10') echo 'selected="selected"'; ?>>
                                    Arifwala
                                </option>
                                <option value="13"<?php if ((Auth::user()->city_id) == '13') echo 'selected="selected"'; ?>>
                                    Badin
                                </option>
                                <option value="15"<?php if ((Auth::user()->city_id) == '15') echo 'selected="selected"'; ?>>
                                    Bahawalpur
                                </option>
                                <option value="18"<?php if ((Auth::user()->city_id) == '18') echo 'selected="selected"'; ?>>
                                    Barbar loi
                                </option>
                                <option value="25"<?php if ((Auth::user()->city_id) == '25') echo 'selected="selected"'; ?>>
                                    Bhawal nagar
                                </option>
                                <option value="26"<?php if ((Auth::user()->city_id) == '26') echo 'selected="selected"'; ?>>
                                    Bhera
                                </option>
                                <option value="28"<?php if ((Auth::user()->city_id) == '28') echo 'selected="selected"'; ?>>
                                    Bhirya road
                                </option>
                                <option value="30"<?php if ((Auth::user()->city_id) == '30') echo 'selected="selected"'; ?>>
                                    Bhurewala
                                </option>
                                <option value="41"<?php if ((Auth::user()->city_id) == '41') echo 'selected="selected"'; ?>>
                                    Chakwal
                                </option>
                                <option value="42"<?php if ((Auth::user()->city_id) == '42') echo 'selected="selected"'; ?>>
                                    Charsada
                                </option>
                                <option value="68"<?php if ((Auth::user()->city_id) == '68') echo 'selected="selected"'; ?>>
                                    Dera ghazi khan
                                </option>
                                <option value="76"<?php if ((Auth::user()->city_id) == '76') echo 'selected="selected"'; ?>>
                                    Dina
                                </option>
                                <option value="85"<?php if ((Auth::user()->city_id) == '85') echo 'selected="selected"'; ?>>
                                    Faisalabad
                                </option>
                                <option value="90"<?php if ((Auth::user()->city_id) == '90') echo 'selected="selected"'; ?>>
                                    Feteh jhang
                                </option>
                                <option value="103"<?php if ((Auth::user()->city_id) == '103') echo 'selected="selected"'; ?>>
                                    Ghotki
                                </option>
                                <option value="111"<?php if ((Auth::user()->city_id) == '111') echo 'selected="selected"'; ?>>
                                    Gujranwala
                                </option>
                                <option value="112"<?php if ((Auth::user()->city_id) == '112') echo 'selected="selected"'; ?>>
                                    Gujrat
                                </option>
                                <option value="118"<?php if ((Auth::user()->city_id) == '118') echo 'selected="selected"'; ?>>
                                    Haroonabad
                                </option>
                                <option value="125"<?php if ((Auth::user()->city_id) == '125') echo 'selected="selected"'; ?>>
                                    Hayatabad
                                </option>
                                <option value="129"<?php if ((Auth::user()->city_id) == '129') echo 'selected="selected"'; ?>>
                                    Hyderabad
                                </option>
                                <option value="132"<?php if ((Auth::user()->city_id) == '132') echo 'selected="selected"'; ?>>
                                    Jaccobabad
                                </option>
                                <option value="141"<?php if ((Auth::user()->city_id) == '141') echo 'selected="selected"'; ?>>
                                    Jaranwala
                                </option>
                                <option value="147"<?php if ((Auth::user()->city_id) == '147') echo 'selected="selected"'; ?>>
                                    Jhang
                                </option>
                                <option value="149"<?php if ((Auth::user()->city_id) == '149') echo 'selected="selected"'; ?>>
                                    Jhelum
                                </option>
                                <option value="174"<?php if ((Auth::user()->city_id) == '174') echo 'selected="selected"'; ?>>
                                    Kasur
                                </option>
                                <option value="176"<?php if ((Auth::user()->city_id) == '176') echo 'selected="selected"'; ?>>
                                    Khair pur
                                </option>
                                <option value="181"<?php if ((Auth::user()->city_id) == '181') echo 'selected="selected"'; ?>>
                                    Khanewal
                                </option>
                                <option value="186"<?php if ((Auth::user()->city_id) == '186') echo 'selected="selected"'; ?>>
                                    Khewra
                                </option>
                                <option value="193"<?php if ((Auth::user()->city_id) == '193') echo 'selected="selected"'; ?>>
                                    Kot addu
                                </option>
                                <option value="202"<?php if ((Auth::user()->city_id) == '202') echo 'selected="selected"'; ?>>
                                    Kotli loharan
                                </option>
                                <option value="203"<?php if ((Auth::user()->city_id) == '203') echo 'selected="selected"'; ?>>
                                    Kotri
                                </option>
                                <option value="227"<?php if ((Auth::user()->city_id) == '227') echo 'selected="selected"'; ?>>
                                    Mandi bahauddin
                                </option>
                                <option value="232"<?php if ((Auth::user()->city_id) == '232') echo 'selected="selected"'; ?>>
                                    Mangla
                                </option>
                                <option value="249"<?php if ((Auth::user()->city_id) == '249') echo 'selected="selected"'; ?>>
                                    Mirpur khas
                                </option>
                                <option value="256"<?php if ((Auth::user()->city_id) == '256') echo 'selected="selected"'; ?>>
                                    Multan
                                </option>
                                <option value="262"<?php if ((Auth::user()->city_id) == '262') echo 'selected="selected"'; ?>>
                                    Muzaffarabad
                                </option>
                                <option value="266"<?php if ((Auth::user()->city_id) == '266') echo 'selected="selected"'; ?>>
                                    Narowal
                                </option>
                                <option value="275"<?php if ((Auth::user()->city_id) == '275') echo 'selected="selected"'; ?>>
                                    Nowshera
                                </option>
                                <option value="278"<?php if ((Auth::user()->city_id) == '278') echo 'selected="selected"'; ?>>
                                    Okara
                                </option>
                                <option value="285"<?php if ((Auth::user()->city_id) == '285') echo 'selected="selected"'; ?>>
                                    Patoki
                                </option>
                                <option value="286"<?php if ((Auth::user()->city_id) == '286') echo 'selected="selected"'; ?>>
                                    Peshawar
                                </option>
                                <option value="302"<?php if ((Auth::user()->city_id) == '302') echo 'selected="selected"'; ?>>
                                    Rahimyar khan
                                </option>
                                <option value="304"<?php if ((Auth::user()->city_id) == '304') echo 'selected="selected"'; ?>>
                                    Raiwand
                                </option>
                                <option value="311"<?php if ((Auth::user()->city_id) == '311') echo 'selected="selected"'; ?>>
                                    Rawalpindi
                                </option>
                                <option value="316"<?php if ((Auth::user()->city_id) == '316') echo 'selected="selected"'; ?>>
                                    Sadiqabad
                                </option>
                                <option value="318"<?php if ((Auth::user()->city_id) == '318') echo 'selected="selected"'; ?>>
                                    Sahiwal
                                </option>
                                <option value="332"<?php if ((Auth::user()->city_id) == '332') echo 'selected="selected"'; ?>>
                                    Sargodha
                                </option>
                                <option value="341"<?php if ((Auth::user()->city_id) == '341') echo 'selected="selected"'; ?>>
                                    Shaikhupura
                                </option>
                                <option value="350"<?php if ((Auth::user()->city_id) == '350') echo 'selected="selected"'; ?>>
                                    Sialkot
                                </option>
                                <option value="358"<?php if ((Auth::user()->city_id) == '358') echo 'selected="selected"'; ?>>
                                    Sohawa district jelum
                                </option>
                                <option value="365"<?php if ((Auth::user()->city_id) == '365') echo 'selected="selected"'; ?>>
                                    Talhur
                                </option>
                                <option value="374"<?php if ((Auth::user()->city_id) == '374') echo 'selected="selected"'; ?>>
                                    Taxila
                                </option>
                                <option value="381"<?php if ((Auth::user()->city_id) == '381') echo 'selected="selected"'; ?>>
                                    Topi
                                </option>
                                <option value="391"<?php if ((Auth::user()->city_id) == '391') echo 'selected="selected"'; ?>>
                                    Vehari
                                </option>
                                <option value="392"<?php if ((Auth::user()->city_id) == '392') echo 'selected="selected"'; ?>>
                                    Wah cantt
                                </option>
                            </select>
                        </div>
