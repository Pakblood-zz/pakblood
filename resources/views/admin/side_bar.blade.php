            ...
            <ul class="off-canvas-list">
                <div class="sidebar_wrapper" id="">
                    ...
                    <ul class="side_nav">
                        ...
                        <li class="">
                            <a  href="{{url('/admin/deleted/users')}}" class=""><i class="fa fa-edit fa-fw"></i> Deleted Users  </a>
                        </li>
                        <li >
                            <a  href="{{url('/admin/organizations')}}" class=""><i class="fa fa-edit fa-fw"></i> Organizations  </a>
                        </li>
                        <li class="">
                            <a  href="{{url('/admin/reports')}}" class=""><i class="fa fa-edit fa-fw"></i> User Reports  </a>
                        </li>
                    </ul>
                </div>
            </ul>
