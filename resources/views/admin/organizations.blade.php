...
<section class="main-section">
    <div class="page_wrapper">
        <div class="row">
            ...
            <a style="position: absolute;right: 0px;top: 2.5%;" href="{{url('/admin/add/organization')}}" class="button radius">Add New Organization </a>
            <div class="bg_icon">
        ...
        <div class="row">
            ...
            @endif
            <div class="row">
                {!! Form::open(array('url' => 'admin/organizations')) !!}
                <div class="">
                ...
                @foreach($orgs as $org)
                    <tr>
                        ...
                        <td class="options_btn">
                            <a data-tooltip aria-haspopup="true" class="has-tip" title="View" href="{{url('admin/organization/'.$org->id)}}"> <li class="fi-eye size-25"></li> </a>
                            <a data-tooltip aria-haspopup="true" class="has-tip" title="Edit" href="{{url('admin/edit/organization/'.$org->id)}}"><li class="fi-page-edit size-25"></li> </a>
                            @if($org->status == 'active')
                                <a data-tooltip aria-haspopup="true" class="tip-left" title="Inactivate" href="{{url('admin/change/organization/status/'.$org->id)}}">
                                    <li class="fi-x-circle size-25"></li>
                                </a>
                            @else
                                <a data-tooltip aria-haspopup="true" class="tip-left" title="Activate" href="{{url('admin/change/organization/status/'.$org->id)}}">
