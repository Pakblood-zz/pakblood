...
<header>
  <div class=" row myCenter ">
    <div class="medium-20 large-11 columns">
      <!-- LOGO -->
      <div class="logo">
        <a href="/">
    ...
    <div class="medium-20 large-9 columns text-right">
      @if (Auth::guest())
      ...
      <div class="social-icons-header">
        <a class="fb" target="_blank" href="https://www.facebook.com/pakblood.official">
          <i class="fi-social-facebook"></i>
        </a>
        <a class="tw" target="_blank" href="https://twitter.com/pak_blood">
          <i class="fi-social-twitter"></i>
        </a>
        <a class="ig" target="_blank" href="https://www.instagram.com/pakblood/">
          <i class="fi-social-instagram"></i>
        </a>
      </div>
      <div class="download-app show-for-medium-down">
        <a target="_blank" href="https://play.google.com/store/apps/details?id=com.aalasolutions.pakblood">
          {!! HTML::image('images/google-play-button.png', 'Pakblood', array('title' => 'pakblood logo')) !!}
        </a>
      </div>
    </div>
  </div>
  ...
  <nav class="top-bar" data-topbar role="navigation" data-options="scrolltop:false">
    ...
    <section class="top-bar-section">
      ...
      <ul>
        ...
        <li class="app-button">
          <div class="download-app hide-for-medium-down">
            <a target="_blank" href="https://play.google.com/store/apps/details?id=com.aalasolutions.pakblood">
              {!! HTML::image('images/google-play-button.png', 'Pakblood-App', array('title' => 'Pakblood App')) !!}
            </a>
          </div>
        </li>
      </ul>
